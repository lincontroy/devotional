...
class FrontendController extends Controller
{
    ...
    public function registerSubmit(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            ...
            'born_again'=>'required',
            'church'=>'required',
            'in_small_group'=>'required',
            // 'group_number'=>'required',
            'in_department'=>'required'
    ...
    public function create(array $data){
        ...
        // dd($data);
        if (isset($data['group_number']) && $data['group_number'] !== null) {
            $gnn = $data['group_number'];
        } else {
            $gnn = 0;
        }
        return User::create([
            ...
            'church'=>$data['church'],
            // 'born_again'=>$data['born_again'],
            'in_small_group'=>$data['in_small_group'],
            'group_number'=>$gnn,
            'in_department'=>$data['in_department'],
